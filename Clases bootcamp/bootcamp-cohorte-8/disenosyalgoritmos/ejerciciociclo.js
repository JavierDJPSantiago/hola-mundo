...
console.log(numeros);//verlas en consola

let resultados = []; // nuevo arreglo que tendra los nuevos valores

numeros.forEach(function(el){
    let multiplicacion = el * 2
    return resultados.push(multiplicacion);//finalizamos la funcion y enviamos el resultado al arreglo
})
console.log(resultados); //ya nos muestra el resultado
